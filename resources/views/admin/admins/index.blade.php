        ...
        <div class="card d-inline-flex">
            <div class="card-header">
                ...
                <div class="card-title">
                    <a href="{{ route('admin.admins.create') }}" class="btn btn-success btn-xs">+ add admin</a>
                </div>
                <div class="card-tools">
                    <form action="{{ route('admin.admins.index') }}" class="d-inline">
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form class="d-inline" action="{{ route('admin.admins.destroy', $data['id']) }}" method="POST" onsubmit="return deleteRow();">
                                    @method('DELETE')
                                    @csrf
