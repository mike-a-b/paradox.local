...
export const fetchAssetPools = () => {
    const url = `/api/v1/user-pools-service/asset-pools`;
...
export const fetchUserAssetPools = () => {
    const url = `/api/v1/user-pools-service/user-asset-pools`;
    return new Promise((resolve, reject) => {
        fetch(url, {
            headers: getBaseHeaders(),
        })
